...
The hook is the canonical enforcement point for push-time policies:
``.indexes/`` paths refused, block portability refused, committer or
captured_by mismatch refused, disallowed prefix refused, force-push
refused, steward-only mutation of policy + members enforced.
"""
